...
> 升级可能带来行为变化，请配合 [体检命令](wiki/07-体检命令.md) 使用。

## 目录

| 章节 | 内容 |
|---|---|
| [01 · 一键安装](wiki/01-一键安装.md) | 三步装好，两分钟见效 |
| [02 · 使用指南](wiki/02-使用指南.md) | 应用内开关 · 插件注释 · 词典热更新 · 覆盖范围 |
| [03 · 架构与原理](wiki/03-架构与原理.md) | 官方 i18n 机制 · 双层翻译 · 可逆性保证 |
| [04 · 构建与发版](wiki/04-构建与发版.md) | 目录结构 · 测试矩阵 · 开发循环 |
| [05 · 更新机制](wiki/05-更新机制.md) | 官方 dsh 升级后的三道防线与标准流程 |
| [06 · 安全与风险](wiki/06-安全与风险.md) | 代码触面 · 攻击面分析 · 信任边界 |
| [07 · 体检命令](wiki/07-体检命令.md) | Doctor：/status 判读 · 快速故障对照 |
| [08 · 常见问题](wiki/08-常见问题.md) | FAQ |
| [09 · 版本历史](wiki/09-版本历史.md) | Changelog v0.1.0 → v0.4.5 |
...
- 针对 `@deepseek-ai/dsh@0.1.1-rc.2`（npx 形态）验证；官方升级后
